...
cd java
mvn install
mvn install -P arrow-jni -am -Darrow.cpp.build.dir=/home/ubuntu/awsindo/dremio-gv2/graviton2/arrow-apache-arrow-4.0.0/cpp/release/release -Dlicense.skip=true -e